...
- [ ] 34-01-PLAN.md — Server + types + Wave-0 RED tests: GROUP_PLACE_ON_CANVAS action, atomic handler, SelectionSource type extraction
- [ ] 34-02-PLAN.md — Client selection foundation: canvas click-to-select, ring/badge, deselect-all, data-card-id attributes on all draggable cards
...
| 34. Multi-Card Group Drop | 0/4 | Planning    | - |
