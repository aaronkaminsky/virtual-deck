...
| 999.39 | Add favicon — site icon for browser tabs and bookmarks |
| 999.40 | Fix browser console source map errors — resolve `installHook.js.map` and `react_devtools_backend_compact.js.map` parse/access errors from React DevTools |
